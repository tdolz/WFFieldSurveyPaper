...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=Temp, y=OccCDF_final), color="#a6bddb", data=co16_1Temp)+
   geom_line(aes(x=Temp, y=SurveyCDFFinal),linetype="dotted", data=shin16coTemp)+
  #geom_line(aes(x=Temp,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=Temp,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=Temp, y=OccCDF_final), color="#1c9099", data=co16_2Temp)+
  geom_ribbon(aes(x=Temp,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=Temp, y=OccCDF_final), color="#a6bddb", data=co17_1Temp)+
    geom_line(aes(x=Temp, y=SurveyCDFFinal),linetype="dotted", data=shin17coTemp)+
  #geom_line(aes(x=Temp,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=Temp,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=Temp, y=OccCDF_final), color="#1c9099", data=co17_2Temp)+
  geom_ribbon(aes(x=Temp,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=DO, y=OccCDF_final), color="#a6bddb", data=co16_1DO)+
   geom_line(aes(x=DO, y=SurveyCDFFinal),linetype="dotted", data=shin16coDO)+
  #geom_line(aes(x=DO,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=DO,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=DO, y=OccCDF_final), color="#1c9099", data=co16_2DO)+
  geom_ribbon(aes(x=DO,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=DO, y=OccCDF_final), color="#a6bddb", data=co17_1DO)+
    geom_line(aes(x=DO, y=SurveyCDFFinal),linetype="dotted", data=shin17coDO)+
  #geom_line(aes(x=DO,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=DO,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=DO, y=OccCDF_final), color="#1c9099", data=co17_2DO)+
  geom_ribbon(aes(x=DO,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=SAL, y=OccCDF_final), color="#a6bddb", data=co16_1SAL)+
   geom_line(aes(x=SAL, y=SurveyCDFFinal),linetype="dotted", data=shin16coSAL)+
  #geom_line(aes(x=SAL,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=SAL,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=SAL, y=OccCDF_final), color="#1c9099", data=co16_2SAL)+
  geom_ribbon(aes(x=SAL,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=SAL, y=OccCDF_final), color="#a6bddb", data=co17_1SAL)+
    geom_line(aes(x=SAL, y=SurveyCDFFinal),linetype="dotted", data=shin17coSAL)+
  #geom_line(aes(x=SAL,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=SAL,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=SAL, y=OccCDF_final), color="#1c9099", data=co17_2SAL)+
  geom_ribbon(aes(x=SAL,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=Depth, y=OccCDF_final), color="#a6bddb", data=co16_1Depth)+
   geom_line(aes(x=Depth, y=SurveyCDFFinal),linetype="dotted", data=shin16coDepth)+
  #geom_line(aes(x=Depth,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=Depth,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=Depth, y=OccCDF_final), color="#1c9099", data=co16_2Depth)+
  geom_ribbon(aes(x=Depth,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
...
#plot occupied, available, both cohorts
a <-  ggplot()
 a+geom_line(aes(x=Depth, y=OccCDF_final), color="#a6bddb", data=co17_1Depth)+
    geom_line(aes(x=Depth, y=SurveyCDFFinal),linetype="dotted", data=shin17coDepth)+
  #geom_line(aes(x=Depth,y=meanboot1),linetype=3, color="#748499")+ # bootstrapped mean
  geom_ribbon(aes(x=Depth,ymin=lcis1,ymax=ucis1),fill="#a6bddb",alpha=0.1)+ #bootstrapped CI
  geom_line(aes(x=Depth, y=OccCDF_final), color="#1c9099", data=co17_2Depth)+
  geom_ribbon(aes(x=Depth,ymin=lcis2,ymax=ucis2),fill="#1c9099",alpha=0.1)+ #bootstrapped CI
