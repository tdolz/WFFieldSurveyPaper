...
cohortcolors2 <-c("#D55E00", "#0072B2")
cohortcolors3 <-c("blue", "dark green")
...
ggplot(aes(y=lncpue,x=Day))+
  geom_point(aes(group=co,y=lncpue,x=Day,color=co, fill=co))+
  scale_fill_manual(values=cohortcolors2)+ scale_color_manual(values=cohortcolors2)+
  scale_x_discrete()+
...
ggsave("cohortslopesALLblue.png", path="/Users/tdolan/Documents/WF SK PROJ/Survey data/Field Survey Paper/final figures")
dev.off()
...
ggplot(aes(y=value,x=Day))+
  geom_point(aes(y=value,x=Day,fill=co,color=co),shape=20, alpha=0.5)+
  scale_x_discrete()+
   #scale_x_discrete(breaks=c("06-02","07-11","08-08","06-01","07-01","08-04","06-02","07-05","08-02"),
  #labels=c("June","July","August","June","July","August","June","July","August"))+
  ...
  strip.text = element_text(size=10),
  legend.position = "none")
ggsave("growthslopecoALL.png", path="/Users/tdolan/Documents/WF SK PROJ/Survey data/Field Survey Paper/final figures")
dev.off()
